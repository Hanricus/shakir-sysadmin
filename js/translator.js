/* ============================================
   TRANSLATOR — Offline Multi-Language
   Supported: ms | en | jp | kr
   ============================================ */
...
(function initTranslator() {
  ...
  // ── Semua language data embedded terus — no fetch needed ──
  const LANG_DATA = {
    ms: {
      nav_about: "Tentang",
      nav_projects: "Projek",
      ...
      hero_title: "IMS IT · Sistem Maklumat · Juruteknik & Pembangun Sistem",
      ...
      section_about_title: "Siapa <span>Abdul Shakir</span>?",
      ...
      interest_val: "Keselamatan Siber Asas · Sistem Maklumat<br/>Keselamatan Rangkaian Asas · Pembangunan Web<br/>Pembangunan Sistem · HRIS",
      footer_hosted: "© 2026 · Dihoskan di GitHub Pages",
      footer_top: "Atas",
    ...
    en: {
      ...
      hero_title: "IMS IT · Information Systems · Technician & System Developer",
      ...
      section_about_title: "Who is <span>Abdul Shakir</span>?",
      ...
      interest_val: "Basic Cybersecurity · Information Systems<br/>Basic Network Security · Web Development<br/>System Development · HRIS",
      footer_hosted: "© 2026 · Hosted on GitHub Pages",
      footer_top: "Top",
      footer_about: "About",
    ...
    jp: {
      ...
      nav_contact: "お問い合わせ",
      hero_tag: "機会を求めています",
      hero_title: "IMS IT · 情報システム · テクニシャン＆システム開発者",
      ...
      section_about_title: "<span>Abdul Shakir</span> とは？",
      ...
      footer_hosted: "© 2026 · GitHub Pages にホスト",
      footer_top: "トップ",
      footer_about: "自己紹介",
    ...
    kr: {
      ...
      hero_title: "IMS IT · 정보 시스템 · 기술자 & 시스템 개발자",
      ...
      section_about_title: "<span>Abdul Shakir</span>는 누구인가요?",
      ...
      footer_hosted: "© 2026 · GitHub Pages 호스팅",
      footer_top: "상단",
      footer_about: "소개",
